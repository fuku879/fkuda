...
const TransactionForm = ({
    ...
    const expenseCategories: CategoryItem[] = [
        ...
        { label: "交際費", icon: <HailIcon fontSize="small" /> },
    ...
    const incomeCategories: CategoryItem[] = [
        ...
        { label: "お小遣い", icon: <PriceCheckIcon fontSize="small" /> },
    ];
    ...
    //this is function that we can change the house hold type
    const incomeExpenseToggle = (type: IncomeExpense) => {
        setValue("type", type);
        setValue("category", "");
    };

    //watch household type
    ...
    return (
        <Box
            sx={{
                position: "fixed",
                top: 64,
                right: isEntryDrawerOpen ? formWidth : "-2%", // adjust the position of form
                width: formWidth,
                height: "100%",
